                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/tagihanwa/'.$tag->idTotalTagihan) }}" title="Kirim data PDF ke whatsapp" rel="noopener noreferrer" class="on-default edit-row btn btn-success" ><i class="
                            fab fa-whatsapp"></i></a>
                        <a href="#" class="btn btn-danger swal-6" data-id="{{ $tag->idTotalTagihan }}">
                            <form action="{{ url('/totalTagihan/'.$tag->idTotalTagihan) }}" id="delete{{ $tag->idTotalTagihan }}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
                            </form>
